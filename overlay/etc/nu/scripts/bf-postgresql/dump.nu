...
export def main [] {
    ...
    { ^pg pg_dumpall } | bf handle -s {|x| $x | save --force $dump_file } dump
    ...
    bf del old (bf env PG_BACKUP) (bf env PG_BACKUP_KEEP_FOR_DAYS | into duration --unit day)
